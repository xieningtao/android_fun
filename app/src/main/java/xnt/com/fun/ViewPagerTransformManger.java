...
public class ViewPagerTransformManger {
    ...
    public static TransformerItem getTransformRandom(){
        int length = TRANSFORM_CLASSES.size();
        Random random = new Random();
        random.setSeed(System.currentTimeMillis());
        int index =  random.nextInt(length);
        return TRANSFORM_CLASSES.get(index);
    }
}
