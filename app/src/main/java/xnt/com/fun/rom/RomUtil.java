...
public class RomUtil {
    ...
    //moto
    public static final String ROM_MOTO = "msm8953";
    ...
    private static final String KEY_VERSION_MOTO = "ro.mot.build.version.release";
    ...
    public static boolean isEmui() {
        return check(ROM_EMUI) || check(ROM_HUAWEI);
    }

    public static boolean isMoto(){
        return check(ROM_MOTO);
    }
    ...
    public static boolean check(String rom) {
        ...
        if (!TextUtils.isEmpty(sVersion = getProp(KEY_VERSION_MIUI))) {
            ...
            sName = ROM_SMARTISAN;
        } else if(!TextUtils.isEmpty(sVersion = getProp(KEY_VERSION_MOTO))){
            sName = ROM_MOTO;
        }else {
    ...
    public static String getProp(String name) {
        ...
        try {
            ...
            L.error(TAG, "Unable to read prop " + name+" eception: "+ex.getMessage());
            return null;
        } finally {
            if (input != null) {
                try {
