...
public class Constant {
    ...
    public static final String ELK_STORAGE_BASE_DIR = com.xnt.sglog.MountedSDCard.getInstance().getExternalSdPath(AppUtil.getApplication());
    ...
    //    public static final String REMOVE_SUFFIX = "-remove";//需要删除的文件
